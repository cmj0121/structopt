...
func (option *Raw) Prepare() (err error) {
...
func (option *Raw) prepare(value reflect.Value) (err error) {
...
func (option *Raw) String() (str string) {
...
func (option *Raw) Name() (name string) {
...
func (option *Raw) Set(args ...string) (count int, err error) {
...
func (option *Raw) set(value reflect.Value, args ...string) (count int, err error) {
	if option.TypeHint() == NONE {
...
// The type of the option
func (option *Raw) Type() (option_type Type) {
	option_type = option.option_type
	return
}

// The type-hint of the option
func (option *Raw) TypeHint() (type_hint TypeHint) {
	type_hint = option.type_hint
	return
}

// Set the callback function
func (option *Raw) SetCallback(fn Callback) {
	option.Callback = fn
}
